...
class Frame(tk.Frame):
    ...
    def campos_pelicula(self):
        ...
        #Entrys de cada camopo de entrada 
        ...
        self.entry_duracion.grid(row = 1, column = 1,  padx = 10, pady = 1, columnspan = 2)
    ...
    def desabilitar_campos(self):
        ...
        self.mi_nombre.set('')#Para enviar datos en blanco a los entry
