...
def login():
    ...
    if nombre == "admin" and password == "admin123":
        ...
        mensaje_label.configure(text="Usuario o password invalidos")

nombre_var = tkinter.StringVar()
password_var = tkinter.StringVar()

nombre_label = tkinter.Label(ventana,text="Nombre Usuario",font=("Arial",18)).pack(padx=20,pady=10)
...
buton_ingresar = tkinter.Button(ventana,text="Ingresar",font=("Arial",18),command=login).pack(padx=20,pady=10)
